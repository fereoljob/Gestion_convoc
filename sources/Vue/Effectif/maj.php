<div class="princip" >
<form action="Effectif/import" method="post" enctype="multipart/form-data" accept=".csv">
    <fieldset>
        <legend><h1>Ajout par import d'un fichier csv</h1></legend>
        <label for="fichier"><h2>Choisissez un fichier à importer dans la table des effectifs</h2></label><br/><br/>
